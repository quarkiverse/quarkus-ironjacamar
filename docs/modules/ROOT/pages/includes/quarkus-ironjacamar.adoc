...
a|icon:lock[title=Fixed at build time] [[quarkus-ironjacamar_quarkus.ironjacamar.ra.cm.pool.metrics.enabled]]`link:#quarkus-ironjacamar_quarkus.ironjacamar.ra.cm.pool.metrics.enabled[quarkus.ironjacamar.ra.cm.pool.metrics.enabled]`

`link:#quarkus-ironjacamar_quarkus.ironjacamar.ra.cm.pool.metrics.enabled[quarkus.ironjacamar."resource-adapter-name".ra.cm.pool.metrics.enabled]`
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_IRONJACAMAR_RA_CM_POOL_METRICS_ENABLED+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_IRONJACAMAR_RA_CM_POOL_METRICS_ENABLED+++`
endif::add-copy-button-to-env-var[]
--|boolean 
|`false`
